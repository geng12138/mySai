...
Route::group('/core', function () {
    ...
    // 计划类型管理
    fastRoute('planType',\plugin\saiadmin\app\controller\system\SystemPlanTypeController::class);
    Route::get("/planType/accessPlanType",[\plugin\saiadmin\app\controller\system\SystemPlanTypeController::class, 'accessPlanType']);

    // 计划模板管理
    fastRoute('planModel',\plugin\saiadmin\app\controller\system\SystemPlanModelController::class);
    Route::get("/planModel/accessPlanModel",[\plugin\saiadmin\app\controller\system\SystemPlanModelController::class, 'accessPlanModel']);
